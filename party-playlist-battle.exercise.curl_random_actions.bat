...
curl -X PUT http://localhost:10001/actions --header "Content-Type: application/json" --header "Authorization: Basic kienboec-ppbToken" -d "{\"actions\": \"random\"}"
curl -X GET http://localhost:10001/actions --header "Authorization: Basic kienboec-ppbToken"
...
curl -X PUT http://localhost:10001/actions --header "Content-Type: application/json" --header "Authorization: Basic altenhof-ppbToken" -d "{\"actions\": \"random\"}"
curl -X GET http://localhost:10001/actions --header "Authorization: Basic altenhof-ppbToken"
